...
//		}
		...
		add(String.valueOf(displayContents));
	}
	
	private void add(final String contents) {
		
		try {
			JSONObject jobj = new JSONObject(contents);
			Bundle data = new Bundle();
			data.putString("pwd", jobj.getString("pwd"));
			data.putString("ip", jobj.getString("ip"));
			
			Message message = Message.obtain();
			message.what = handler.ASKADD;
