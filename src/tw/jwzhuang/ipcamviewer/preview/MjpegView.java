...
public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
	...
	public class MjpegViewThread extends Thread {
		...
		public MjpegViewThread(SurfaceHolder surfaceHolder, Context contextt) {
...
//								if (cappic) {
//									final Bitmap tmp = bm.copy(Bitmap.Config.ARGB_8888, false);
//									cappic = false;
//									new Thread() {
//										@Override
//										public void run() {
//											super.run();
//											mjcallback.saveJPEG(tmp);
//										}
//									}.start();
//								}
